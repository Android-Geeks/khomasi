...
data class PlaygroundScreenResponse(
    ...
    val playground: com.company.rentafield.domain.models.playground.PlaygroundX,
    @SerialName("playgroundPictures")
    val playgroundPictures: List<com.company.rentafield.domain.models.playground.PlaygroundPicture>
)
