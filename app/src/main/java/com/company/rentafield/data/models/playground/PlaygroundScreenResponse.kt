...
data class PlaygroundScreenResponse(
    ...
    val playground: com.company.rentafield.data.models.playground.PlaygroundX,
    @SerialName("playgroundPictures")
    val playgroundPictures: List<com.company.rentafield.data.models.playground.PlaygroundPicture>
)
